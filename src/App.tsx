...
const FlashcardApp = () => {
  ...
  return (
    <div className="bg-gray-100 p-4 rounded-lg max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold text-center mb-4 text-gray-800">
        Gurmukhi to Hindi Flashcards
      </h1>

      <div className="flex justify-center mb-4 flex-wrap">
        <button
          className={`px-3 py-1 m-1 rounded-lg ${
      ...
      {currentCategory === "words" && (
        <div className="flex justify-center mb-4 flex-wrap">
          <button
            className={`px-2 py-1 m-1 text-sm rounded-lg ${
